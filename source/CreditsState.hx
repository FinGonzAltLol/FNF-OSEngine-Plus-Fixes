...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(FlxG.width * 0.7, FlxG.height - 24, 0, "Press CTRL for Psych Engine Discord", 12);
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['EliteMasterEric',		'unknown',			'Runtime Shaders support',								'https://twitter.com/EliteMasterEric',		'FFBD40'],
			['Gabriela',			'unknown',			'Playback Rate Modifier\nand other PRs',						'https://twitter.com/BeastlyGabi',		'5E99DF'],
			['PolybiusProxy',		'proxy',			'.MP4 Video Loader Library (hxCodec)',							'https://twitter.com/polybiusproxy',		'DCD294'],
			['KadeDev',			'kade',				'Fixed some cool stuff on Chart Editor\nand other PRs',					'https://twitter.com/kade0912',			'64A250'],
			['Keoiki',			'keoiki',			'Note Splash Animations',								'https://twitter.com/Keoiki_',			'D2D2D2'],
			['Nebula the Zorua',		'nebula',			'LUA JIT Fork, some Lua reworks, and extra texture packer support',							'https://twitter.com/Nebula_Zorua',		'7D40B2'],
			['Smokey',			'smokey',			'Sprite Atlas Support',									'https://twitter.com/Smokey_5_',		'483D92'],
			['Raltyro',			'unknown',			'Bunch of lua fixes',									'https://twitter.com/raltyro',			'D2D2D2'],
			['UncertainProd',		'unknown',			'Sampler2D in Runtime Shaders',								'https://github.com/UncertainProd',		'D2D2D2'],
			['ACrazyTown',			'unknown',			'Optimized PNGs',									'https://twitter.com/acrazytown',		'A03E3D'],
			[''],
			["Funkin' Crew"],

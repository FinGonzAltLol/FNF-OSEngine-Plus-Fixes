...
class AchievementsMenuState extends MusicBeatState
{
	...
	override function create() {
		...
		for (i in 0...Achievements.achievementsStuff.length) {
			if(!Achievements.achievementsStuff[i][4] || Achievements.achievementsMap.exists(Achievements.achievementsStuff[i][2]) || Achievements.achievementsMap.exists(Achievements.achievementsStuff[i][3])) {
